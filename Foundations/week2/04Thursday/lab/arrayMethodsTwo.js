...
// CODE HERE
let newArray = numbers.map(number => number / 2);
...
// CODE HERE
let newCities = cities.filter((element) => element[element.length - 1] === "i")
...
// CODE HERE
let riceTotal = foods.filter((food) => food.tags.includes("rice")).reduce((acc, curr) => acc + curr.price, 0)
console.log(riceTotal);
// THE TOTAL
// the total of all of the rice items is $36