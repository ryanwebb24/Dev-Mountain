...
// CODE HERE
const funcName = (param1, param2) => `The first parameter is ${param1}. The second parameter is ${param2}`
...
function greeting(firstName, lastName, callbackFunc){
    return callbackFunc(firstName, lastName)
}

// INVOKE 'GREETING FUNCTION' HERE
console.log(greeting("ryan", "webb", ((a, b) => `Hello my name is ${a} ${b}`)))
...
// CODE HERE
function pricePlusTax(arr, callback){
    for (let i in arr){
...
// CODE HERE
console.log(pricePlusTax(prices, (a) => `The new array plus tax = ${a}` ))
