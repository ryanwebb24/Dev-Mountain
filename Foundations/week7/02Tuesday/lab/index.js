...
// ANSWER: No i was wrong (number[4] it would be complexity of O(1))
...
// ANSWER: well the object is always thye same amount of space taken up the values are the only things that change 
