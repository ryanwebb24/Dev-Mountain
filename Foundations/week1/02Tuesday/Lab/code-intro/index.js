...
let total = Hulu + Peacock + Netfilx + Disney + YouTube;
...
let newTotal = Hulu + Peacock + Netfilx + Disney + YouTube;
...
let savings = Math.trunc(newTotal / total * 100);
console.log(`${savings}%`);
