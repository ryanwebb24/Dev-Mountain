...
// Do not edit the code below.
var nums = [1, 2, 3, 6, 22, 98, 45, 23, 22, 12, 33, 66];
let evensArr = [];
// Do not edit the code above.
...
//Code Here
for (let item in listOfNumbers) {
  if (listOfNumbers[item] % 3 === 0) {
    console.log(`${listOfNumbers[item]} is divisible by 3`);
  }
}
...
for (let letter of lettersReverse) {
  console.log(letter);
}
...
switch (letterGrade) {
  ...
  case "F":
    ...
    break;
  default:
    console.log("That is not a possible letter grade");
}
